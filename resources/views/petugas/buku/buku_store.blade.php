                    ...
                    <form action="{{ route('buku.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-10">
                                ...
                                <input type="number" name="kode_buku" class="form-control @error('kode_buku') is-invalid @enderror" id="validationCustom01" placeholder="Kode Buku" value="{{ old('kode_buku') }}" autofocus>
                                @error('kode_buku')
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-10">
                                ...
                                <input type="text" name="judul_buku" class="form-control @error('judul_buku') is-invalid @enderror" id="validationCustom01" placeholder="Judul Buku" value="{{ old('judul_buku') }}">
                                @error('judul_buku')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-10">
                                ...
                                <input type="text" name="penerbit" class="form-control @error('penerbit') is-invalid @enderror" value="{{ old('penerbit') }}" placeholder="Penerbit">
                                @error('penerbit')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-10">
                                <label>Penulis</label>
                                <input type="text" name="penulis" class="form-control @error('penulis') is-invalid @enderror" value="{{ old('penulis') }}" placeholder="Penulis">
                                @error('penulis')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-8 mb-10">
                                ...
                                <textarea name="sinopsis" class="form-control @error('sinopsis') is-invalid @enderror" placeholder="Sinopsis">{{ old('sinopsis') }}</textarea>
                                @error('sinopsis')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-2 mb-10">
                                ...
                                <input type="number" name="stok" class="form-control @error('stok') is-invalid @enderror" id="validationCustom01" value="{{ old('stok') }}" placeholder="Stok Buku">
                                @error('stok')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
