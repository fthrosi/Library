...
@php $list[$rak->id_rak] = ['count' => 1] @endphp
<div class="d-flex justify-content-center align-items-center">
    <div class="col-lg-10 col-md-6 mt-3" style="background-color: white;border-bottom: 1px darkslategray solid;">
        <div class="row me-1">
            ...
            <div class="col mt-2">
                <a href="{{ route('bukuRak', ['id_rak' => $rak->id_rak]) }}" class="d-flex justify-content-end align-items-end mt-3 fw-semibold" style="color:darkslategray;text-decoration: none;">SEE ALL</a>
            </div>
        </div>
        <div class="row">
            @forelse($buku as $item)
            @if($item->rak == $rak->id_rak && $list[$rak->id_rak]['count'] <= 6)
            @php $list[$rak->id_rak] = ['count' => $list[$rak->id_rak]['count'] + 1] @endphp
                ...
                <div class="card-body ps-0">
                    ...
                    <ul class="d-flex align-items-start justify-content-start p-0" style="list-style: none;">
                        <li class="d-flex align-items-start justify-content-start ">
                            <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#buku_{{$item->id_buku}}" style="background-color: darkslategray;color: white;" {{ $item->id_pinjam != null ? 'disabled' : ''}}>
                                Borrow
                            </button>
                        </li>
                    </ul>
            ...
            <div class="modal fade" id="buku_{{$item->id_buku}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
